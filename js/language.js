...
const translations = {
  en: {
    ...
    experience_main_title: "Main Experience",
    experience_secondary_title: "Secondary Experience & Certifications",
  ...
  ar: {
    ...
    experience_main_title: "الخبرات المهنية الرئيسية",
    experience_secondary_title: "الخبرات والشهادات الإضافية",
