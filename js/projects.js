    ...
    card.innerHTML = `
      ...
      <div class="project-content">
        ...
        <div class="project-actions">
          <button class="btn-primary" onclick="window.location.href='projects.html'">${btnText}</button>
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if (isProjectsPage || isHomePage) {
    ...
    if (isProjectsPage) {
      const mainProjects = currentProjects.slice(0, 3);
      const secondaryProjects = currentProjects.slice(3);
    ...
    if (isHomePage) {
      // Only feature projects with status "Active" or limit to 3
